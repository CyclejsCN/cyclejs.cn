...
const apiDocs = [
  'index', 'dom', 'history', 'html', 'http', 'isolate', 'jsonp', 'most-run', 
  'run', 'rxjs-run'
]

apiDocs.forEach(docName => {

  var mdFilename = __dirname + '/../content/api/' + docName + '.md';
  var htmlFilename = __dirname + '/../api/' + docName + '.html';
